	...
	public class RankingSceneManager : MonoBehaviour
	{
		...
		IEnumerator GetHighScoreAndRankingBoard ()
		{
			...
			//ハイスコア取得
			{
                ...
                var hiScoreCheck = new SpreadSheetQuery (DataManager.Instance.UseData.musicData.name);
		...
		private IEnumerator SendScoreEnumerator ()
		{
			...
			//ハイスコア送信
			if (this.highScoreSpreadSheetObject == null) {
                this.highScoreSpreadSheetObject = new SpreadSheetObject (DataManager.Instance.UseData.musicData.name);
		...
		private IEnumerator LoadRankingBoard ()
		{
            ...
            var so = new SpreadSheetQuery (DataManager.Instance.UseData.musicData.name);
